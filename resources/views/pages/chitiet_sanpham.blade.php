			...
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="beta-products-list">
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="product.html"><img src="front/image/product/{{$tt->image}}" alt="" height="250px"></a>
									</div>
									<div class="single-item-body">
						...
						<div class="row" style="text-align: center;">{{$sp_tuongtu->links('pagination::bootstrap-4')}}</div>
